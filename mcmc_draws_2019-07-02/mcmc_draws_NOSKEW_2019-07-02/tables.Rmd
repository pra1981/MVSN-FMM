...
est_c3_noskew <- est_c3 <- c(beta_est_c1,sig2_est_c1,psi_est_c1,delta_est,pi_est[1])
est_c2_noskew <- est_c2 <- c(beta_est_c2,sig2_est_c2,psi_est_c2,delta_est,pi_est[2])
est_c1_noskew <- est_c1 <- c(beta_est_c3,sig2_est_c3,psi_est_c3,delta_est,pi_est[3])
