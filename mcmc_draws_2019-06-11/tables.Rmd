...
```{r}
rownames(t1) <- NULL
kable(t1, booktabs = T, escape = F,caption = "Model results for simulated data with n = 1500, k = 2, p = 2, h = 3, v = 1. 5000 iterations were run with a burn in of 1000. Missingness mechanism was MAR and P(miss) = 0") %>%
