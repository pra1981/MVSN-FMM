...
model_component <- c("MVSN","Regression","","","","","","","","","","","","","","","","",
                     "Multinom.","",
                     "Clustering")
params <- c("$\\beta_{0}$","$\\beta_{1}$","$\\beta_{2}$","$\\beta_{3}$",
...
```{r}
rownames(t1) <- NULL
kable(t1, booktabs = T, escape = F,caption = "Model results for simulated data with n = 1500, k = 4, p = 1, h = 3, v = 1. 5000 iterations were run with a burn in of 1000. Missingness mechanism was MAR and P(miss) = 0") %>%
