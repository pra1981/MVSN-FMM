...
```{r}
rownames(t1) <- NULL
kable(t1, booktabs = T, escape = F,caption = "Model results for simulated data with n = 1000, J = 4, p = 2, K = 3, r = 2. 1,000 iterations were run with a burn in of 0. Missingness mechanism was MAR and P(miss) = 0") %>%
